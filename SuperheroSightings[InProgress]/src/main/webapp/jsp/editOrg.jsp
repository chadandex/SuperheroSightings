...
<html>
    ...
    <body>
        <div class="container" style="color:white;">
            ...
            <sec:authorize access="hasRole('ROLE_MOD')" var="isMod" />
            <c:if test="${isMod} && !${isAdmin}">
                <div align="center">
                    <small><p>! <i>Currently viewing as 'Sidekick' and may only assign/delete Superheroes/Supervillains associated</i> !</p></small>
                </div>
            </c:if>
            <div align="center">
